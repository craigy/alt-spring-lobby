...
#_
(count minimap-header)

#_
(decode-map-header
  (clojure.java.io/input-stream
    (clojure.java.io/file "/mnt/c/Users/craig/Desktop/Dworld Acidic.smf")))
#_
(decode-map
  (clojure.java.io/input-stream
    (clojure.java.io/file "/mnt/c/Users/craig/Desktop/Dworld Acidic.smf")))
#_ ; TODO
(let [map-data (decode-map
                 (clojure.java.io/input-stream
                   (clojure.java.io/file "/mnt/c/Users/craig/Desktop/Dworld Acidic.smf")))
      {:keys [body header]} map-data]
  ;(type (:minimap body))
  ;(count (:minimap body))
  (let [minimap-bytes (concat-bytes minimap-header (:minimap body))]
    (println minimap-bytes)
    (println (count minimap-bytes))
    (with-open [fos (java.io.FileOutputStream. "/mnt/c/Users/craig/Desktop/Dworld Acidic.minimap.png")]
      (.write fos minimap-bytes))
    #_
    (with-open [is (clojure.java.io/input-stream minimap-bytes)]
      (println is)
      (let [image (javax.imageio.ImageIO/read is)]
        (println image)
        (javax.imageio.ImageIO/write image "png" (clojure.java.io/file "/mnt/c/Users/craig/Desktop/Dworld Acidic.minimap.png")))))
  #_
  (spit
    "/mnt/c/Users/craig/Desktop/Dworld Acidic.heightmap.png"
    (:heightmap body))
  #_
  (spit
    "/mnt/c/Users/craig/Desktop/Dworld Acidic.metalmap.png"
    (:metalmap body)))
#_
(quot 1792 28) ; 64 block map size
