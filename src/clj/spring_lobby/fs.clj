...
(defn spring-root
  ...
  (if (string/starts-with? (System/getProperty "os.name") "Windows")
    ...
    (do
      ...
      "/mnt/c/Users/craig/Documents/My Games/Spring")))
...
#_
(-> (lua/parse (->> "/mnt/c/Users/craig/Desktop/mapinfo.lua" io/file slurp))
    second
    second)
#_
(parse-map-info (->> "/mnt/c/Users/craig/Desktop/mapinfo.lua" io/file slurp))
